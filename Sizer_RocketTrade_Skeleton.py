...
rocketData  = np.genfromtxt('RocketData.csv',delimiter=',',dtype='f8')# load in the data file
nDataPointsMass = 100
...
for jj,indRocket in enumerate(rockSweep):   
    ...
    for ii,mLaunch in enumerate(mSeparated):
        ...
        engMain = cf.Engine(470, 25000, 5.5, 'Biprop', 'Cryo') # Fill in values from hydrogen
...
legString=('Goal', 'Scout','Juno','Nike','Vanguard') # initialize the list for the legend, add in the rocket names
fig1 = plt.figure()
